...
export class PersonaCard extends React.Component<
  ...
  private _LivePersonaCard() {
    ...
    const userPrincipleName = this.props.profileProperties.Email;
    const userPrincipleNameModified = userPrincipleName.replace(/@oakhilladvisors.com/g, "@ohpny.com");

    return React.createElement(
      this.state.livePersonaCard,
      {
        serviceScope: this.props.context.serviceScope,
        upn: userPrincipleNameModified,
        onCardOpen: () => {
