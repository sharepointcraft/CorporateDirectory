...
const DirectoryHook: React.FC<IDirectoryProps> = (props) => {
            ...
            .then((client: AadHttpClient) => {
                ...
                return client
                    .get(
                        ...
                        `https://graph.microsoft.com/v1.0/users?$select=id,displayName,mail,officeLocation,userPrincipalName,userType,accountEnabled,companyName,onPremisesDistinguishedName&$count=true&ConsistencyLevel=eventual&$filter=accountEnabled eq true and userType eq 'Member' and endsWith(userPrincipalName, '@ohpny.com') and companyName ne null and department ne null&$top=999`,
    ...
    return (
        <div className={styles.directory}>
            ...
            <span><button onClick={_ResetAlphabets} type='button' className={styles.searchBox} style={{marginLeft:'645px',marginBottom:'-45px', padding:'6px 14px'}}>Reset</button></span>
