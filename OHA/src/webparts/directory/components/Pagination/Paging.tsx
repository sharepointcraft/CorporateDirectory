...
const Paging: React.FC<IPagingProps> = (props) => {
	...
	return (
		<div className={styles.paginationContainer}>
			<div className={styles.searchWp__paginationContainer__pagination} style={{ paddingLeft: '20%'}}>
				<Pagination
					activePage={currentPage}
					firstPageText={<Icon className='ms-Icon ms-Icon--DoubleChevronLeft' aria-hidden='true'></Icon >}
